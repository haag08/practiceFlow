<script lang="ts">
  ...
  const soundTypes = $derived([
    { label: i18n.t('metronome.sounds.classic'), value: 'classic' },
    { label: i18n.t('metronome.sounds.woodblock'), value: 'woodblock' },
    { label: i18n.t('metronome.sounds.digital'), value: 'digital' }
  ]);
